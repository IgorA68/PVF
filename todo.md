...
- [x] Decide the first public release version once the voxel and pixel-art scope is frozen.
- [x] Add release tags for the first public release.
- [x] Do a final smoke pass across voxel and pixel-art entry points before publication.

Current status: the repository now has CI coverage, a documented 1.0.0 release in the changelog, the first public release tag, and completed GUI and CLI smoke checks across the voxel and pixel-art entry points.
